...
filler_course = {
    '1': ['106', 'Rnadom1', '1', 'May 24 @ 9 pm', 'May 27 @ 11 pm', '10%']
}

for i in range(4):
    func.add_onto_course_table(filler_course[1][0], filler_course[1][1], filler_course[1][2], filler_course[1][3], filler_course[1][4], filler_course[1][5])